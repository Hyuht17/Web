...
// Tải bài viết từ localStorage khi trang được load
document.addEventListener('DOMContentLoaded', function() {
    console.log('📥 Đang tải bài viết từ localStorage...');
    renderArticles();
    console.log(' Hoàn thành tải bài viết!');
});
